...
# Change Column names, select only concessions and select only some variables
```{r}
...
# Create a variable with the annual FEC and DEC
```{r}
...
# Prepare the DEC & FEC dataset from 1993-2016
```{r}
# Wide to long format
...
colnames(dec_1993_2016_long) <- c("Firm", "Year", "DEC")

colnames(fec_1993_2016_long) <- c("Firm", "Year", "FEC")
...
# Merge the dataset dec_fec_1993_1999 and annual_DEC_FEC 
```{r}
...
print(unique(dec_fec_1993_1999$Firm))
