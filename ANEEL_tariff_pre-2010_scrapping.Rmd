...
for (pdf_file in pdf_files) {
  tryCatch({
    ...
    extract_first_valid_row_and_save(pdf_file, output_folder, "B4a", "B4a_REDE_DE_DISTRIBUICAO")
    #extract_first_valid_row_and_save(pdf_file, output_folder, "Consumo mensal", "CONSUMO_MENSAL_ATE_30KWH")
  }, error = function(e) {
    message("Error processing file ", pdf_file, ": ", e$message)
  })
}
