...
#1. Combine retrieve of "B1_RESIDENCIAL", "B2_RURAL", or "B3_DEMAIS"
```{r}
...
variables <- c("B1_RESIDENCIAL", "B2_RURAL", "B3_DEMAIS", "B4a_REDE_DE_DISTRIBUICAO", "CONSUMO_MENSAL_ATE_30KWH")
  ...
  tryCatch({
    ...
    for (var in variables) {
      ...
      if (length(matching_sheet) > 0) {
        ...
        sheet_data <- read_excel(excel_file, sheet = matching_sheet, range = "A2:D2", col_names = FALSE)
